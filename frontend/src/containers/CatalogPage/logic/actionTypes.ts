...
export const LOAD_BOOKS_FAIL = "CATALOG:BOOKS:LOAD:FAIL";
...
export const LOAD_RECOMMENDATIONS = "CATALOG:BOOKS:RECOMMENDED:LOAD";
export const LOAD_RECOMMENDATIONS_SUCCESS = "CATALOG:BOOKS:RECOMMENDED:LOAD:SUCCESS";
