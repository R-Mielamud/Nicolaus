...
export const loadBooksFail = createAction(actionTypes.LOAD_BOOKS_FAIL);
...
export const loadRecommendations = createAction<actionTypes.LoadRecommendations>(actionTypes.LOAD_RECOMMENDATIONS);
